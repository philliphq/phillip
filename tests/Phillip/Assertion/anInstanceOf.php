...
})->covers(Assertion::class, 'anInstanceOf');
...
})->expect(AssertionFailureException::class, 'Object of type "stdClass" is not an instance of "Phillip\Test"')->covers(Assertion::class, 'anInstanceOf');
...
})->expect(AssertionFailureException::class, '"that" is not an instance of "Phillip\Test"')->covers(Assertion::class, 'anInstanceOf');

test('Test anInstanceOf with an empty array', function (Test $test) {
    $test->is([])->anInstanceOf(Test::class);
})->expect(AssertionFailureException::class, 'Array is not an instance of "Phillip\Test"')->covers(Assertion::class, 'anInstanceOf');
...
})->expect(AssertionFailureException::class, 'Object of type "stdClass" is an instance of "stdClass"')->covers(Assertion::class, 'anInstanceOf');
